...
public class TaskManagerRunner implements FatalErrorHandler, AutoCloseableAsync {
	...
	public static void main(String[] args) throws Exception {
		startTaskManager(args);
	}


	public static ResourceID startTaskManager(String[] args) throws Exception {

		ResourceID indicateResourceId = null;
		String[] params = new String[2];
		if (args.length == 3) {
			indicateResourceId = new ResourceID(args[0]);
			params[0] = args[1];
			params[1] = args[2];
			args = params;
		}
		...
		ResourceID resourceID = indicateResourceId == null ? ResourceID.generate() : indicateResourceId;
